  ...
  return (
    <header className="w-full bg-white sticky top-0 z-50 border-b">
      ...
      >
        ...
        >
          <div
            className={`bg-[#a4d145] rounded-lg flex items-center justify-center transition-all duration-300 ease-in-out ${
              scrolled ? "p-1" : "p-2"
            }`}
          >
            <svg
